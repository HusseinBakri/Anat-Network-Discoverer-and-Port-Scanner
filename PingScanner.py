...
def display_header():
  ...
  _____  _                  _____                                       
 |  __ \(_)                / ____|                                      
 | |__) |_  _ __    __ _  | (___    ___  __ _  _ __   _ __    ___  _ __ 
 |  ___/| || '_ \  / _` |  \___ \  / __|/ _` || '_ \ | '_ \  / _ \| '__|
 | |    | || | | || (_| |  ____) || (__| (_| || | | || | | ||  __/| |   
 |_|    |_||_| |_| \__, | |_____/  \___|\__,_||_| |_||_| |_| \___||_|   
                    __/ |                                               
                   |___/                                                
                                                  
                                              
             by Dr. Hussein Bakri\n""", 'green')
        cprint("PingScanner.py is licensed under MIT\n",'green')
...
def ping(base, given_range):
	...
	if len(base.strip().split(".")) == 4:
		...
		cprint("Your base IP is a complete IP. I am checking it only and ignoring the range provided\n")
