...
[![MIT Licence](https://badges.frapsoft.com/os/mit/mit.png?v=103)](https://opensource.org/licenses/mit-license.php) [![Build Status](https://travis-ci.org/HusseinBakri/Anat-Network-Discoverer-and-Port-Scanner.svg?branch=master)](https://travis-ci.org/HusseinBakri/Anat-Network-Discoverer-and-Port-Scanner)
